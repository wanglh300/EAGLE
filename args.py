...
def add_args(parser):
    ...
    parser.add_argument("--latent_num_blocks", type=int, default=1,
                        help='Number of stacked CNFs.')
    parser.add_argument("--layer_type", type=str, default="concat_v2", choices=LAYERS)
    ...
    parser.add_argument('--data_dir', type=str, default="/root/autodl-tmp/data/ShapeNetCore.v2.PC15k",
                        help="Path to the training data")
    parser.add_argument('--mn40_data_dir', type=str, default="/root/autodl-tmp/data/ModelNet40.PC15k",
                        help="Path to ModelNet40")
    parser.add_argument('--mn10_data_dir', type=str, default="/root/autodl-tmp/data/ModelNet10.PC15k",
