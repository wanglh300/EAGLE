...
from . import foundamental_layers
...
class ODEnet(nn.Module):
    ...
    def __init__(self, hidden_dims, input_shape, context_dim, layer_type="concat_v2", nonlinearity="softplus"):
        super(ODEnet, self).__init__()
        base_layer = {
            "concat_v2": foundamental_layers.ConcatLinear_v2,
            "concatsquash": foundamental_layers.ConcatSquashLinear,
        }[layer_type]
