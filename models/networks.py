...
class ResidualBlock(nn.Module):
    def __init__(self, in_channels):
        ...
        self.conv1 = nn.Conv1d(in_channels, in_channels, kernel_size=1, stride=1, padding=0)
        self.bn1 = nn.BatchNorm1d(in_channels)
        self.conv2 = nn.Conv1d(in_channels, in_channels, kernel_size=1, stride=1, padding=0)
...
class EAGLE(nn.Module):
    ...
    def forward(self, x, opt, step, writer=None):
        ...
        if writer is not None:# add loss
